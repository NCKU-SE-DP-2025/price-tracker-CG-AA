...
class NewsCrawlerBase(metaclass=abc.ABCMeta):
    ...
    def validate_and_parse(self, url: AnyHttpUrl | str) -> News:
        ...
        it raises a `DomainMismatchError`. If the URL is valid, the method passes the URL to the `parse` method
        ...
        :raises DomainMismatchError: If the URL does not belong to the allowed domain or its child URLs.
        """
